<aside
    ...
    <nav class="mt-5 px-3 space-y-2">
        ...
        <a href="{{ route('admin.dashboard') }}" class="flex items-center gap-4 px-4 py-3 rounded-xl hover:bg-white/20">
        ...
        <a href="{{ route('admin.users.index') }}"
            ...
            <span x-show="!sidebarMini">Users</span>

        </a>

        <a href="{{ route('admin.departments.index') }}" class="flex items-center gap-4 px-4 py-3 rounded-xl hover:bg-white/20">
