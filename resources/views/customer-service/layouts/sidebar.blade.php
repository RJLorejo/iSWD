<aside
    ...
    <nav class="mt-5 px-3 space-y-2">
        ...
        <a href="{{ route('customer-service.dashboard') }}"
        ...
        <a href="{{ route('customer-service.consumers.index') }}"
            ...
            <span x-show="!sidebarMini">Consumer
            </span>
        ...
        <a href="{{ route('customer-service.complaint-verification.index') }}" class="flex items-center gap-4 px-4 py-3 rounded-xl hover:bg-white/20">

            <i class="fa-solid fa-shield-halved w-6"></i>

            <span x-show="!sidebarMini">Verify Complaints
            </span>
        ...
        <a href="{{ route('customer-service.complaint-categories.index') }}"
            ...
            <span x-show="!sidebarMini">Complaint Categories</span>
        ...
        <a href="#"
            ...
            <span x-show="!sidebarMini">Account</span>
