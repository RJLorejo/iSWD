        ...
        <div class="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
                                            ...
                                            <div class="space-y-2">
                                                ...
                                                @foreach ($complaint->technicians as $technician)
                                                    <div class="flex items-center gap-2">
                                                        ...
                                                        <div
                                                            class="w-7 h-7 rounded-full bg-blue-100
                                                                text-blue-700 flex items-center
                                                                justify-center text-[10px]
                                                                font-bold shrink-0">

                                                            {{ strtoupper(substr($technician->full_name ?? '', 0, 1) . substr($technician->last_name ?? '', 0, 1)) }}
                                                        ...
                                                        <div class="min-w-0">
                                                            ...
                                                            <p
                                                                class="text-sm font-medium text-gray-800 truncate max-w-[150px]">
            ...
            @else
                ...
                <div class="px-6 py-16 text-center">
                    ...
                    <div
                        class="mx-auto w-16 h-16 rounded-2xl bg-gray-100
